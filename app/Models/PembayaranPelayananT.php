...
class PembayaranPelayananT extends Model
{
    ...
    public static function getTarifSIMRSCount(int $pembayaranpelayanan_id)
    {
    ...
    private static function buildBaseQueryTandaBuktiBayar()
    {
        $laporan = DB::table('tandabuktibayar_t')
            ...
            ->leftJoin('obatalkespasien_t', 'pembayaranpelayanan_t.pendaftaran_id', '=', 'obatalkespasien_t.pendaftaran_id')
