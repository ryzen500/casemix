                ...
                <div className="sidebar-wrapper active">
                    ...
                    <div className="sidebar-menu">
                        <ul className="menu">
                            ...
                            <Sidebar menuItems=
                            {[
                                { id: 1, label: "Transaksi", submenu: [{label:"Coding / Group ",link:route('searchGroupper')},{label:"Kirim Data Online",link:route('kirimDataOnline')}
                                    // {label:"Pengajuan Klaim",link:"a2.html"}
                                ]}
                            ]}></Sidebar>
                            <Sidebar menuItems=
                            {[
